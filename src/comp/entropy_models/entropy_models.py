...
from compressai._CXX import pmf_to_quantized_cdf as _pmf_to_quantized_cdf # GS keep
from comp.ops import LowerBound
...
class _EntropyCoder:
    ...
    def __init__(self, method):
        ...
        from comp import available_entropy_coders
        ...
        if method == "ans":
            from compressai import ans # GS keep
...
def default_entropy_coder():
    from comp import get_entropy_coder
