...
from comp.zoo import load_state_dict, models
...
def setup_args():
    ...
    parent_parser.add_argument(
        "-c",
        "--entropy-coder",
        choices=comp.available_entropy_coders(),
        default=comp.available_entropy_coders()[0],
...
def main(argv):
    ...
    comp.set_entropy_coder(args.entropy_coder)
