...
from compressai.ans import BufferedRansEncoder, RansDecoder # GS keep
from comp.entropy_models import EntropyBottleneck, GaussianConditional
from comp.layers import GDN
from .utils import conv, deconv, update_registered_buffers
from comp.ops import ste_round
from comp.layers import conv3x3, subpel_conv3x3, Win_noShift_Attention
from .base import CompressionModel
from comp.layers import Win_GraphPyg
...
class WinGraph_WA(WACNN):
    def __init__(self, N=192, M=320, knn = 9, graph_conv = 'transf', heads = 8, use_edge_attr = False, dissimilarity = False, **kwargs):
        super().__init__(**kwargs)
        print(f'\n-----   WinGraph_WA model \n\
              knn: {knn} \n\
